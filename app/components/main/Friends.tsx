...
const Friends = () => {
    return (
        <div className='flex gap-[5em] bg-[#fff] rounded-[3em] mb-[6.5em] p-[2.5em] '>
            <div className='flex flex-col gap-[19em] max-w-full w-[38.5em] pt-[2.5em] pl-[2.5em] pb-[2.5em]'>
                <h2 className='tracking-[-0.02em] text-[7.5em] font-normal leading-[1] mt-0 mb-0 '> Friends & Partners</h2>
                <div className='flex items-start gap-[4em] '>
                    <div className='flex flex-col items-center gap-[1.5em]'>
                        ...
                        <p className={`${myfont.variable} font-fk text-[0.875em] font-normal leading-[1.4em] mt-0`}>Startup</p>
                    </div>
                    <div className='flex flex-col items-center gap-[1.5em]'>
                        <Image src={established} alt='' className='w-6.5em]' />
                        <p className={`${myfont.variable} font-fk text-[0.875em] font-normal leading-[1.4em] mt-0`}> Established</p>
                    </div>
                    <div className='flex flex-col items-center gap-[1.5em]'>
                        <Image src={enterprise} alt='' className='w-6.5em]' />
                        <p className={`${myfont.variable} font-fk text-[0.875em] font-normal leading-[1.4em] mt-0`}> Enterprise</p>
                    </div>
