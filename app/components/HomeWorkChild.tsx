...
const HomeWorkChild = ({ protitle, desc, src, handleTap, selectedBox, boxIndex }: any) => {
    ...
    return (
        <motion.div onTap={handleTap} variants={boxVariants} initial={{ width: '15%' }} animate={selected ? 'selected' : ''} className='flex flex-col relative pt-[11.5em] pl-[0.75em] pr-[0.75em]'>
            <div className='flex flex-col items-start gap-[0.5em] w-[30em] pl-[0.75em] absolute top-[0%] left-[0%] flex-none'>
                ...
                <div className='overflow-hidden relative'>
                    ...
                    <div className='flex-none'>
                        <motion.div transition={{ duration: 0.3, }} style={{ y: '120%' }} animate={selected ? 'text' : ''} variants={boxVariants} className=''>
                            <p className={`${myfont.variable} font-fk text-[1.125em] font-normal leading-[1.3] mb-0`}>{desc}</p>
                        </motion.div>
                    </div>
                </div>
            ...
            <motion.div className='cursor-pointer rounded-[2.5em] flex-col justify-center items-center h-[32em] flex relative overflow-hidden'>
                ...
                <div className='rounded-[100vw] max-w-[11em] absolute bottom-[2em] right-[2em] overflow-hidden '>
                    <motion.div style={{ scale: 0 }} transition={{ duration: 0.3, }} animate={selected ? { scale: 1 } : ''} className='origin-[100%_100%]' >
                        <a href="" className='bg-[#fff] text-[#05070f] flex gap-[1em] rounded-[100vw] justify-center items-center px-[2.5em] py-[1em] max-w-full'>
                            <div className={`${myfont.variable} font-fk text-[1.125em] font-normal leading-[1.3]`}>View</div>
                ...
                <div className='absolute rounded-[0.5em] bottom-[2em] left-[2em] overflow-hidden'>
                    <motion.div style={{ scale: 0 }} transition={{ duration: 0.3, }} animate={selected ? { scale: 1 } : ''} className='flex items-center gap-[0.5em] origin-[0_100%]  '>
                        <div className='bg-[#21242c] text-[#fff] rounded-[0.5em] h-[2em] py-[0.5em] px-[0.75em]'>
                            <div className={`${myfont.variable} font-fk text-[0.75em] font-normal leading-[1.4]`}> Brand</div>
                        </div>
                        <div className='bg-[#21242c] text-[#fff] rounded-[0.5em] h-[2em] py-[0.5em] px-[0.75em]'>
                            <div className={`${myfont.variable} font-fk text-[0.75em] font-normal leading-[1.4]`}>Web</div>
                        </div>
                        <div className='bg-[#21242c] text-[#fff] rounded-[0.5em] h-[2em] py-[0.5em] px-[0.75em]'>
                            <div className={`${myfont.variable} font-fk text-[0.75em] font-normal leading-[1.4]`}>Illustration</div>
                        </div>
                    </motion.div>
                </div>
            </motion.div>
